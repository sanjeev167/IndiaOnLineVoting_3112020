...
<section class="content-header">
	<h1>Loksabha Master</h1>
	<ol class="breadcrumb">
		<li><a href="#"><i class="fa fa-dashboard"></i> Dashboard</a></li>
		<li class="active">Loksabha Master</li>
	</ol>
</section>
			...
			<div class="modal-body">
				...
				<form class="form-horizontal" id="commonFormId" action="">
					<div class="box-body">
						...
						<div class="form-group" id="loksabhaLabledId">
...
<script src="${contextPath}/resources/assets/pageSpecific/js/loksabha.js"></script>

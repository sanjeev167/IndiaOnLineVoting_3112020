...
<section class="content-header">
	<h1>Loksabha-Candidate Master</h1>
	<ol class="breadcrumb">
		<li><a href="#"><i class="fa fa-dashboard"></i> Dashboard</a></li>
		<li class="active">Loksabha-Candidate Master</li>
	</ol>
</section>
...
<script src="${contextPath}/resources/assets/pageSpecific/js/lcandidate.js"></script>

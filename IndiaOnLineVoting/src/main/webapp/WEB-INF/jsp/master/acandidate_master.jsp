...
<section class="content-header">
	<h1>Assembly-Candidate Master</h1>
	<ol class="breadcrumb">
		<li><a href="#"><i class="fa fa-dashboard"></i> Dashboard</a></li>
		<li class="active">Assembly-Candidate Master</li>
	</ol>
</section>
...
<script src="${contextPath}/resources/assets/pageSpecific/js/acandidate.js"></script>

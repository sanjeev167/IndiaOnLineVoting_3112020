...
<section class="content-header">
	<h1>&nbsp;&nbsp;&nbsp;&nbsp;Assembly List [ <strong>EC Test Data</strong> ]</h1>
	<ol class="breadcrumb">
		<li><a href="#"><i class="fa fa-dashboard"></i> Dashboard</a></li>
		<li class="active">Assembly List</li>
	</ol>
</section>
					...
					<div class="box-body">
						...
						<div class="form-group" id="assemblyLabledId">
							<label for="inputSortName" class="col-sm-4 control-label">
								Assembly</label>
							<div class="col-sm-7">
								<input type="text" class="form-control" name="assemblyName"
									id="assemblyNameId" placeholder="Assembly Name"> <span
									id="assemblyNameId_err" class="field-error"></span>
							</div>
						</div>

                        <div class="form-group" id="assemblyNoLabledId">
							<label for="inputSortName" class="col-sm-4 control-label">
								No</label>
							<div class="col-sm-7">
								<input type="text" class="form-control" name="assemblyNo"
									id="assemblyNoId" placeholder="Assembly No"> <span
									id="assemblyNoId_err" class="field-error"></span>
							</div>
						</div>
						<input hidden="true" name="id" id="assemblyRecordId" />
					</div>
					<!-- /.box-body -->
...
<script src="${contextPath}/resources/assets/pageSpecific/js/assembly_list.js"></script>

...
<section class="content-header">
	<h1>&nbsp;&nbsp;&nbsp;&nbsp;Loksabha-Candidate List [ <strong>EC Test Data</strong> ]</h1>
	<ol class="breadcrumb">
		<li><a href="#"><i class="fa fa-dashboard"></i> Dashboard</a></li>
		<li class="active">Loksabha-Candidate List</li>
	</ol>
</section>
	...
	<div class="row">
		<div class="col-md-9">
			<div class="box box-primary ">
				...
				<div class="box-body ">
					<table  id="loksabhaCandidateId" width="100%"
			...
			<div class="modal-body">
				...
				<form class="form-horizontal" id="commonFormId" action="">
					<div class="box-body">
						...
						<div class="form-group" id="lcandidateNameLabledId">
							<label for="inputSortName" class="col-sm-4 control-label">
								Candidate</label>
							<div class="col-sm-7">
								<input type="text" class="form-control" name="lcandidateName"
									id="lcandidateNameId" placeholder="Candidate Name"> <span
									id="lcandidateNameId_err" class="field-error"></span>
							</div>
						</div>
                        ...
                        <div class="form-group" id="lcandidateNoLabledId">
							<label for="inputSortName" class="col-sm-4 control-label">
								Position </label>
							<div class="col-sm-7">
								<input type="text" class="form-control" name="lcandidateNo"
									id="lcandidateNoId" placeholder="Ballet-Position"> <span
									id="lcandidateNoId_err" class="field-error"></span>
							</div>
						</div>
						<input hidden="true" name="id" id="lcandidateRecordId" />
					</div>
					<!-- /.box-body -->
...
<script src="${contextPath}/resources/assets/pageSpecific/js/lcandidate_list.js"></script>

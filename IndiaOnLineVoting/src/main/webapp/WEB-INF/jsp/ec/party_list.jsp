...
<section class="content-header">
	<h1>&nbsp;&nbsp;&nbsp;&nbsp;Party List [ <strong>EC Test Data</strong> ]</h1>
	<ol class="breadcrumb">
					...
					<div class="box-body">
						...
						<div class="form-group" id="partySymbolIdLableId">
							<label for="inputSortName"  class="col-sm-4 control-label">
								Symbol</label>
							<div class="col-sm-7">
								<select id="partySymbolIdId" name="partySymbolId"  class="form-control" style="width: 100%;"></select>								
...
<script src="${contextPath}/resources/assets/pageSpecific/js/party_list.js"></script>

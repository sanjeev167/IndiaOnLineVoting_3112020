...
<body>
	...
	<section class="content-header">
		<h1>Cast Online-Vote </h1>
		<ol class="breadcrumb">
			<li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
			<li class="active">Cast your Online-Vote</li>
		</ol>
	</section>
				...
				<div class="box box-primary">
					<div class="box-body box-profile">
						<img class="profile-user-img img-responsive img-circle"
							src="<%request.getContextPath();%>/resources/assets/ec/img/onlineVote.jpg">
			...
			<div class="col-md-6" style="margin-right: 0px; margin-left: 0px;">
				...
				<div class="box">
					...
					<div class="box-body">
						...
						<table id="online" class="table table-striped table-bordered table-hover table-condensed dt-responsive data-table">
							<thead>
								<tr>
									<th>#</th>
									<th>ID</th>
...
loadGrid(voterId,electionType);
			...
			t = $('#online').DataTable(
					{
						...
						"aaSorting" : [ [ 3, "asc" ]],
						"ajax" : {							
							"url" : "/pvt/vote/onlineBalletPaperPaginated?voterId="+voterId+"&electionType="+electionType,
							"type" : "POST",
						},
						...
						"columns" : [
							...
							{
								"data" : "loksabhaCandidateId",
								"name" : "loksabhaCandidateId",
								"title" : "ID",
								"searchable" : false,
							...
							{
								"data" : "loksabhaCandidateName",
								"name" : "loksabhaCandidateName",
								"title" : "Candidate"
							},
							{
								"data" : "partyName",
							...
							{
		                    	"render": function (data, type, JsonResultRow, meta) {			                    	
		                            return  '<a href="#" class="voteClass"><input type="radio" name="vote" value="'+JsonResultRow.partyNameId+"#"+JsonResultRow.loksabhaCandidateId+'">&nbsp;&nbsp; <img	class="img-circle voteClass" width="50" height="50"	src="<%request.getContextPath();%>/resources/assets/ec/img/vote2.jpg"></a>';
		                        },
		                        "searchable" : false,
		                        "title" : "Cast-Vote"
							}
		...
		$("#online").on("click", "input[type=radio]", function() {			

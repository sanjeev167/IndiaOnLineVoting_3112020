...
function reloadGrid() {
	...
	window.location.replace("/pvt/master/Lcandidate/");
...
function searchAndReloadGrid(stateNameId,loksabhaNameId,lcandidateName) {
	clearCheckBoxSelection();
	var table = $('#loksabhaCandidateId').DataTable();
	table.ajax.url(
			"/pvt/master/Lcandidate/paginated?stateNameId=" + stateNameId + "&loksabhaNameId=" +loksabhaNameId).load();
	...
	$(".chkIndvRow").each(function() {
		if ($(this).is(':checked')) {
			...
			checkedRowNames.push(selectedRows[0].stateName +" => "+
					             ...
					             +selectedRows[0].lcandidateName + "</br>");
...
var t;
function loadGrid(stateNameId,loksabhaNameId,lcandidateName) {
	t = $('#loksabhaCandidateId').DataTable(
			{
				"responsive": true,
				...
				"ajax" : {
					...
					"url" : "paginated?stateNameId=" + stateNameId + "&loksabhaNameId=" + loksabhaNameId+"&lcandidateName="+lcandidateName,
...
var baseUrl = '/pvt/master/Lcandidate';
...
function cleanAllMsg() {
	...
	$('#lcandidateNameId_err').html("");
	$('#lcandidateNoId_err').html("");
...
function applyReadOnlyProp() {	
	...
	$('#lcandidateNameId').prop("readonly", true);
	$('#lcandidateNoId').prop("readonly", true);	
...
function removeReadOnlyProp() {	
	...
	$('#lcandidateNameId').prop("readonly", false);
	$('#lcandidateNoId').prop("readonly", false);
...
function loadRecordInForm(response) {
	$('#lcandidateRecordId').val(response.id);	
	...
	$('#lcandidateNameId').val(response.lcandidateName);
...
function showBusinessEerror(fieldErrMsgMap) {	
	...
	$('#lcandidateNameId_err').html(fieldErrMsgMap.lcandidateName);
	$('#lcandidateNoId_err').html(fieldErrMsgMap.lcandidateNo);
...
function saveAndUpdateRecord() { 
	...
	var id = $('#lcandidateRecordId').val();	
	var stateNameId = $('#stateNameId').val();	
	var loksabhaNameId = $('#loksabhaNameId').val();
	var lcandidateName = $('#lcandidateNameId').val();
	var lcandidateNo = $('#lcandidateNoId').val();	
	...
	var json = {
			...
			"lcandidateName" : lcandidateName,
			"lcandidateNo" : lcandidateNo,

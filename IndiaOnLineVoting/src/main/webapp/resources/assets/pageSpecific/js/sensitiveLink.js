...
function reloadGrid() {
	...
	//var table = $('#sensitiveLinkId').DataTable();
	...
	window.location.replace("/pvt/adm/");
	...
	t = $('#sensitiveLinkId').DataTable(
			{
				...
				"columns" : [
					...
					},
					{
						"searchable" : false,
						// "orderable" : false,
						"data" : "activateStartDateS",
						"name" : "activateStartDateS",
						"title" : "Start Date"
					},
					
					{
						"searchable" : false,
						// "orderable" : false,
						"data" : "activateEndDateS",
						"name" : "activateEndDateS",
						"title" : "End Date"
					},
					{
						"searchable" : false,
...
function clearFormData() {
	...
	$('#nameId').val("");
	$('#pageUrlId').val("");
	$('#activateStartDateSId').val("");
	$('#activateEndDateSId').val("");
	
	
	$('#activationMessageId').val("");
	$('#denyMessageId').val("");
	$('#channelStateSId').val("");
...
function cleanAllMsg() {
	...
	$('#name_err').html("");
	$('#activateStartDateS_err').html("");
	$('#activateEndDateS_err').html("");
	
	$('#activationMessage_err').html("");
	$('#denyMessage_err').html("");
	
	$('#channelStateS_err').html("");
...
function applyReadOnlyProp() {
	...
	$('#pageUrlId').prop("readonly", true);
	$('#activateStartDateSId').prop("readonly", true);
	$('#activateEndDateSId').prop("readonly", true);
	
	$('#activationMessageId').prop("readonly", true);
	$('#denyMessageId').prop("readonly", true);
	$('#channelStateSId').attr("disabled", true);
...
function removeReadOnlyProp() {
	...
	$('#pageUrlId').prop("readonly", false);
	$('#activateStartDateSId').prop("readonly", false);
	$('#activateEndDateSId').prop("readonly", false);
	
	$('#activationMessageId').prop("readonly", false);
	$('#denyMessageId').prop("readonly", false);
	$('#channelStateSId').attr("disabled", false);
...
function loadRecordInForm(response) {
	$('#sensitiveLinkRecordId').val(response.id);
	$('#nameId').val(response.name);
	$('#pageUrlId').val(response.pageUrl);
	$('#activateStartDateSId').val(response.activateStartDateS);
	$('#activateEndDateSId').val(response.activateEndDateS);
	
	$('#activationMessageId').val(response.activationMessage);
	$('#denyMessageId').val(response.denyMessage);
	
	$('#channelStateSId').val(response.channelStateS);
...
function showBusinessEerror(fieldErrMsgMap) {
	...
	$('#pageUrl_err').html(fieldErrMsgMap.pageUrl);
	$('#activateStartDateS_err').html(fieldErrMsgMap.activateStartDateS);
	$('#activateEndDateS_err').html(fieldErrMsgMap.activateStartDateS);
	
	$('#activationMessage_err').html(fieldErrMsgMap.activationMessage);
	$('#denyMessage_err').html(fieldErrMsgMap.denyMessage);
	$('#channelStateS_err').html(fieldErrMsgMap.channelStateS);
...
function saveAndUpdateRecord() { 
	...
	var id = $('#sensitiveLinkRecordId').val();
	var name = $('#nameId').val();
	var pageUrl = $('#pageUrlId').val();
	var activateStartDateS = $('#activateStartDateSId').val();
	var activateEndDateS = $('#activateEndDateSId').val();
	
	var activationMessage =$('#activationMessageId').val();
	var denyMessage =$('#denyMessageId').val();
	var channelStateS =$('#channelStateSId').val();
	...
	var json = {
			...
			"name" : name,
			"pageUrl" : pageUrl,
			"activateStartDateS" : activateStartDateS,
			"activateEndDateS":activateEndDateS,

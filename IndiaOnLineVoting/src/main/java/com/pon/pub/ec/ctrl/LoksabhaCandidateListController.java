...
@Controller
@RequestMapping(value = "/pub/ec/Lcandidates/")
public class LoksabhaCandidateListController {
	static final Logger log = LoggerFactory.getLogger(LoksabhaCandidateListController.class);
	@Autowired
	LoksabhaCandidateService loksabhaCandidateService;

	@RequestMapping(value = "", method = RequestMethod.GET)
	public String listLcandidate(Model model) {
		log.info("LoksabhaCandidateListController :==> listLcandidate :==> Started");
		String target = "/ec/lcandidate_list";
		log.info("LoksabhaCandidateListController :==> listLcandidate :==> End");
		return target;
	}
	...
	public String listLcandidatePaginated(HttpServletRequest request, HttpServletResponse response, String stateNameId,
		...
		log.info("LoksabhaCandidateListController :==> listLcandidatePaginated :==> Started");
		...
		log.info("LoksabhaCandidateListController :==> listLcandidatePaginated :==> End");
	...
	public String getRecord(@RequestParam Integer id, HttpServletRequest request, HttpServletResponse response){
		log.info("LoksabhaCandidateListController :==> getRecord :==> Started");
		...
		log.info("LoksabhaCandidateListController :==> getRecord :==> End");
	...
	public String saveAndUpdateRecord(@RequestBody @Valid LoksabhaCandidateMasterDTO loksabhaCandidateMasterDTO, BindingResult result,
		...
		log.info("LoksabhaCandidateListController :==> saveAndUpdateRecord :==> Started");
		JsonResponse jsonResponse = new JsonResponse();
		try {
			if (result.hasErrors()) {
				// Get error message
		...
		log.info("LoksabhaCandidateListController :==> saveAndUpdateRecord :==> End");
		return new Gson().toJson(jsonResponse);
	...
	public String deleteRecord(@RequestParam Integer id, HttpServletRequest request, HttpServletResponse response)
			throws Exception {
		log.info("LoksabhaCandidateListController :==> deleteRecord :==> Started");
		JsonResponse jsonResponse = new JsonResponse();
		try {
		...
		log.info("LoksabhaCandidateListController :==> deleteRecord :==> End");
		return new Gson().toJson(jsonResponse);
	...
	public String deleteSelected(@RequestBody Integer[] recordIdArray, HttpServletRequest request,
		...
		log.info("LoksabhaCandidateListController :==> deleteSelected :==> Started");
		JsonResponse jsonResponse = new JsonResponse();
		try {			
		...
		log.info("LoksabhaCandidateListController :==> deleteSelected :==> End");
		return new Gson().toJson(jsonResponse);
	...
	@ResponseBody public String lcandidateList(@RequestParam Integer id,HttpServletRequest request,	HttpServletResponse response) {
		log.info("LoksabhaCandidateListController :==> lcandidateList :==> Start");
		JsonResponse jsonResponse=new JsonResponse();		
		try {			 	
		...
		log.info("LoksabhaCandidateListController :==> lcandidateList :==> End");
		return new Gson().toJson(jsonResponse);
	}
}

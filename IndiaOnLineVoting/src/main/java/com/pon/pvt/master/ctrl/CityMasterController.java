...
import com.pon.pvt.master.service.CityService;
...
@Controller
@RequestMapping(value = "/pvt/master/city/")
public class CityMasterController{
	...
	public String listCities(Model model) {
		...
		String target = "/master/city_master";
	...
	public String getRecord(@RequestParam Integer id, HttpServletRequest request, HttpServletResponse response){
		...
		request.isUserInRole("ROLE_MASTER");
	
		//System.out.println("CC  = "+request.isUserInRole(role));

 ...
 */
@Controller
@RequestMapping("/pvt/vote/") 
public class OnlineBalletPaperController {
	
	static final Logger log = LoggerFactory.getLogger(OnlineBalletPaperController.class);
	...
	public String listCandidateInBalletPaper(@RequestParam(required = false) String voterId,@RequestParam(required = false) String electionType,Model model,HttpServletRequest request, HttpServletResponse response) {
		log.info("OnlineBalletPaperController :==> listCandidateInBalletPaper :==> Started");
		String target="";
		String targetA ="/vote/assemblyOnline";
	...
	if(sensetivePagelinkMaster.isChannelState()) {	
		...
		log.info("OnlineBalletPaperController :==> listCandidateInBalletPaper :==> End");
		return target;		
		
	}
	
	
	@RequestMapping(value = "onlineBalletPaperPaginated", method = RequestMethod.POST)
	@ResponseBody
	public String balletPaperPaginated( @RequestParam String voterId,  @RequestParam String electionType, HttpServletRequest request, HttpServletResponse response){
		...
		log.info("OnlineBalletPaperController :==> assemblyBalletPaperPaginated :==> Started");
		String ballet="";
	...
	public String receiveVote( @RequestBody @Valid VoteDetailDTO voteDetailDTO, BindingResult result, HttpServletRequest request, HttpServletResponse response){
		...
		log.info("OnlineBalletPaperController :==> receiveVote :==> Started");		
